#!/usr/bin/env python3
"""
Advanced Embeddings Model 3: Multi-QA MPNet Base Dot v1 with Threshold Optimization
=================================================================================

Implementation of cosine similarity classification with:
- multi-qa-mpnet-base-dot-v1 embeddings (optimized for QA and similarity)
...
CONFIG = {
    ...
    'experiment_name': 'multi_qa_mpnet',
    'threshold_search': {
...
def save_results(osdg_df, assignments, similarity_matrix, optimization_results, metrics, best_params, config):
    ...
    csv_path = output_dir / f"multi_qa_mpnet_results_{timestamp}.csv"
    results_df.to_csv(csv_path, index=False)
    print(f"Results saved to: {csv_path}")
    
    # Save optimization results
    optimization_df = pd.DataFrame(optimization_results)
    opt_path = output_dir / f"multi_qa_mpnet_optimization_{timestamp}.csv"
    ...
    stats_path = output_dir / f"multi_qa_mpnet_stats_{timestamp}.json"
...
def print_experiment_report(optimization_results, metrics, best_params, config):
    ...
    print("\n" + "="*70)
    print("ADVANCED EMBEDDINGS MODEL 3: MULTI-QA-MPNET-BASE-DOT-V1")
    print("="*70)
...
def main():
    ...
    print("Starting Advanced Embeddings Model 3: multi-qa-mpnet-base-dot-v1")
    ...
    print(f"\nModel 3 (Multi-QA MPNet) experiment completed successfully!")
