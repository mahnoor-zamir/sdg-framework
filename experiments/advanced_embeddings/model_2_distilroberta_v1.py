#!/usr/bin/env python3
"""
Advanced Embeddings Model 2: DistilRoBERTa v1 with Threshold Optimization
========================================================================

Implementation of cosine similarity classification with:
- all-distilroberta-v1 embeddings (fast and efficient transformer)
...
CONFIG = {
    ...
    'experiment_name': 'distilroberta_v1',
    'threshold_search': {
...
def save_results(osdg_df, assignments, similarity_matrix, optimization_results, metrics, best_params, config):
    ...
    csv_path = output_dir / f"distilroberta_v1_results_{timestamp}.csv"
    results_df.to_csv(csv_path, index=False)
    print(f"Results saved to: {csv_path}")
    
    # Save optimization results
    optimization_df = pd.DataFrame(optimization_results)
    opt_path = output_dir / f"distilroberta_v1_optimization_{timestamp}.csv"
    ...
    stats_path = output_dir / f"distilroberta_v1_stats_{timestamp}.json"
...
def print_experiment_report(optimization_results, metrics, best_params, config):
    ...
    print("\n" + "="*70)
    print("ADVANCED EMBEDDINGS MODEL 2: ALL-DISTILROBERTA-V1")
    print("="*70)
...
def main():
    ...
    print("Starting Advanced Embeddings Model 2: all-distilroberta-v1")
    ...
    print(f"\nModel 2 (DistilRoBERTa v1) experiment completed successfully!")
